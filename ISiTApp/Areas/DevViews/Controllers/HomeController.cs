...
using ISiTApp.ViewModel;
using Microsoft.AspNetCore.Mvc;

namespace ISiTApp.Areas.DevViews.Controllers
{
    [Area("DevViews")]
    public class HomeController : Controller
    {
        ...
        {
            Company microsoft = new (1, "Microsoft", "USA");
            Company google = new (2, "Google", "USA");
            Company jetbrains = new (3, "JetBrains", "Czech Republic");
